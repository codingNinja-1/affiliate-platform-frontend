...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <main className="mx-auto flex max-w-4xl flex-col gap-6 bg-gray-50 px-6 py-10">
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        {editing ? (
          <form onSubmit={handleUpdate} className="space-y-4">
            <div>
              <label className="mb-2 block text-sm text-gray-700 font-medium">First name</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-2 block text-sm text-gray-700 font-medium">Last name</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-2 block text-sm text-gray-700 font-medium">Phone</label>
              <input
                type="tel"
