              ...
              <div key={product.id} className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-gray-200 transition-all overflow-hidden flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    {isAffiliate && (
                      <button className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl bg-green-600 hover:bg-green-700 px-3 py-2 text-xs font-semibold text-white transition">
