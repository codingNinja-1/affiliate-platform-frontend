    ...
    <div className="flex min-h-screen bg-slate-950 text-white">
      ...
      <main className="ml-64 flex-1 p-8">
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-4xl font-bold">Payment Settings</h1>
          <p className="text-slate-400">Configure Paystack payment gateway</p>
        </div>

        {message && (
          <div className="mb-6 rounded-lg border border-green-500/50 bg-green-500/10 px-4 py-3 text-sm text-green-100">
            {message}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Use test API keys for development</p>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Use live API keys for production</p>
                </div>
              </label>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-slate-700 bg-slate-800 px-4 py-2 text-white placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-md border border-slate-700 bg-slate-800 px-4 py-2 pr-12 text-white placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 rounded-md bg-blue-600 px-6 py-3 text-sm font-medium text-white hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <Save size={20} />
            ...
            <button
              ...
              className="rounded-md border border-slate-700 px-6 py-3 text-sm font-medium text-slate-200 hover:border-slate-500"
            >
              Cancel
            </button>
          </div>
