  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType !== 'superadmin' && userType !== 'admin') {
        try {
          const checkRes = await fetch('http://127.0.0.1:8000/api/settings/check-bank-details', {
            headers: {
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative">
        ...
        <div className="flex justify-between items-center px-8 py-6 relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-xl font-semibold">Trakr</span>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 relative z-10">
          <div className="w-full max-w-md">
            <div className="bg-[#12131f] border border-[#1e2035] rounded-2xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 mt-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-[#0a0b14] border border-[#1e2035] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#6366f1] focus:ring-1 focus:ring-[#6366f1] transition"
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Link href="/forgot-password" className="text-[#6366f1] text-sm hover:text-[#818cf8] transition">
                      Forgot Password?
                    </Link>
                  </div>
                  <input
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 bg-[#0a0b14] border-[#1e2035] rounded text-[#6366f1] focus:ring-[#6366f1] focus:ring-offset-0"
                  />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#6366f1] hover:bg-[#5558e3] disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-medium py-3 rounded-lg transition flex items-center justify-center"
                >
                  {loading ? (
              ...
              <div className="flex gap-4 mt-6">
                <button className="flex-1 flex items-center justify-center gap-2 bg-[#0a0b14] border border-[#1e2035] text-gray-300 py-3 rounded-lg hover:bg-[#1e2035] transition">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex-1 flex items-center justify-center gap-2 bg-[#0a0b14] border border-[#1e2035] text-gray-300 py-3 rounded-lg hover:bg-[#1e2035] transition">
                  ...
                  <span className="text-sm">Sing in with Microsoft</span>
                </button>
              </div>
        ...
        {/* Footer */}
        <div className="flex justify-between items-center px-8 py-6 relative z-10">
          <span className="text-gray-500 text-sm">© 2024 Trakr</span>
